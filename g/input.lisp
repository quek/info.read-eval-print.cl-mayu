...
(cl:defconstant CLOCK_BOOTTIME 7)

(cl:defconstant CLOCK_REALTIME_ALARM 8)

(cl:defconstant CLOCK_BOOTTIME_ALARM 9)

(cl:defconstant CLOCK_SGI_CYCLE 10)

(cl:defconstant CLOCK_TAI 11)
...
(cl:defconstant INPUT_PROP_POINTER #x00)

(cl:defconstant INPUT_PROP_DIRECT #x01)

(cl:defconstant INPUT_PROP_BUTTONPAD #x02)

(cl:defconstant INPUT_PROP_SEMI_MT #x03)

(cl:defconstant INPUT_PROP_TOPBUTTONPAD #x04)

(cl:defconstant INPUT_PROP_POINTING_STICK #x05)

(cl:defconstant INPUT_PROP_ACCELEROMETER #x06)

(cl:defconstant INPUT_PROP_MAX #x1f)

(cl:defconstant INPUT_PROP_CNT (cl:+ #x1f 1))
...
(cl:defconstant SYN_DROPPED 3)

(cl:defconstant SYN_MAX #xf)

(cl:defconstant SYN_CNT (cl:+ #xf 1))
...
(cl:defconstant KEY_ROTATE_DISPLAY 153)
...
(cl:defconstant KEY_BRIGHTNESS_AUTO 244)

(cl:defconstant KEY_BRIGHTNESS_ZERO 244)

(cl:defconstant KEY_DISPLAY_OFF 245)

(cl:defconstant KEY_WWAN 246)

(cl:defconstant KEY_WIMAX 246)

(cl:defconstant KEY_RFKILL 247)

(cl:defconstant KEY_MICMUTE 248)
...
(cl:defconstant BTN_SOUTH #x130)

(cl:defconstant BTN_A #x130)

(cl:defconstant BTN_EAST #x131)

(cl:defconstant BTN_B #x131)

(cl:defconstant BTN_C #x132)

(cl:defconstant BTN_NORTH #x133)

(cl:defconstant BTN_X #x133)

(cl:defconstant BTN_WEST #x134)
...
(cl:defconstant BTN_TOOL_QUINTTAP #x148)
...
(cl:defconstant KEY_BRIGHTNESS_TOGGLE #x1af)
...
(cl:defconstant KEY_10CHANNELSUP #x1b8)

(cl:defconstant KEY_10CHANNELSDOWN #x1b9)

(cl:defconstant KEY_IMAGES #x1ba)
...
(cl:defconstant KEY_NUMERIC_A #x20c)

(cl:defconstant KEY_NUMERIC_B #x20d)

(cl:defconstant KEY_NUMERIC_C #x20e)

(cl:defconstant KEY_NUMERIC_D #x20f)

(cl:defconstant KEY_CAMERA_FOCUS #x210)

(cl:defconstant KEY_WPS_BUTTON #x211)

(cl:defconstant KEY_TOUCHPAD_TOGGLE #x212)

(cl:defconstant KEY_TOUCHPAD_ON #x213)

(cl:defconstant KEY_TOUCHPAD_OFF #x214)

(cl:defconstant KEY_CAMERA_ZOOMIN #x215)

(cl:defconstant KEY_CAMERA_ZOOMOUT #x216)

(cl:defconstant KEY_CAMERA_UP #x217)

(cl:defconstant KEY_CAMERA_DOWN #x218)

(cl:defconstant KEY_CAMERA_LEFT #x219)

(cl:defconstant KEY_CAMERA_RIGHT #x21a)

(cl:defconstant KEY_ATTENDANT_ON #x21b)

(cl:defconstant KEY_ATTENDANT_OFF #x21c)

(cl:defconstant KEY_ATTENDANT_TOGGLE #x21d)

(cl:defconstant KEY_LIGHTS_TOGGLE #x21e)

(cl:defconstant BTN_DPAD_UP #x220)

(cl:defconstant BTN_DPAD_DOWN #x221)

(cl:defconstant BTN_DPAD_LEFT #x222)

(cl:defconstant BTN_DPAD_RIGHT #x223)

(cl:defconstant KEY_ALS_TOGGLE #x230)

(cl:defconstant KEY_BUTTONCONFIG #x240)

(cl:defconstant KEY_TASKMANAGER #x241)

(cl:defconstant KEY_JOURNAL #x242)

(cl:defconstant KEY_CONTROLPANEL #x243)

(cl:defconstant KEY_APPSELECT #x244)

(cl:defconstant KEY_SCREENSAVER #x245)

(cl:defconstant KEY_VOICECOMMAND #x246)

(cl:defconstant KEY_BRIGHTNESS_MIN #x250)

(cl:defconstant KEY_BRIGHTNESS_MAX #x251)

(cl:defconstant KEY_KBDINPUTASSIST_PREV #x260)

(cl:defconstant KEY_KBDINPUTASSIST_NEXT #x261)

(cl:defconstant KEY_KBDINPUTASSIST_PREVGROUP #x262)

(cl:defconstant KEY_KBDINPUTASSIST_NEXTGROUP #x263)

(cl:defconstant KEY_KBDINPUTASSIST_ACCEPT #x264)

(cl:defconstant KEY_KBDINPUTASSIST_CANCEL #x265)

(cl:defconstant BTN_TRIGGER_HAPPY #x2c0)

(cl:defconstant BTN_TRIGGER_HAPPY1 #x2c0)

(cl:defconstant BTN_TRIGGER_HAPPY2 #x2c1)

(cl:defconstant BTN_TRIGGER_HAPPY3 #x2c2)

(cl:defconstant BTN_TRIGGER_HAPPY4 #x2c3)

(cl:defconstant BTN_TRIGGER_HAPPY5 #x2c4)

(cl:defconstant BTN_TRIGGER_HAPPY6 #x2c5)

(cl:defconstant BTN_TRIGGER_HAPPY7 #x2c6)

(cl:defconstant BTN_TRIGGER_HAPPY8 #x2c7)

(cl:defconstant BTN_TRIGGER_HAPPY9 #x2c8)

(cl:defconstant BTN_TRIGGER_HAPPY10 #x2c9)

(cl:defconstant BTN_TRIGGER_HAPPY11 #x2ca)

(cl:defconstant BTN_TRIGGER_HAPPY12 #x2cb)

(cl:defconstant BTN_TRIGGER_HAPPY13 #x2cc)

(cl:defconstant BTN_TRIGGER_HAPPY14 #x2cd)

(cl:defconstant BTN_TRIGGER_HAPPY15 #x2ce)

(cl:defconstant BTN_TRIGGER_HAPPY16 #x2cf)

(cl:defconstant BTN_TRIGGER_HAPPY17 #x2d0)

(cl:defconstant BTN_TRIGGER_HAPPY18 #x2d1)

(cl:defconstant BTN_TRIGGER_HAPPY19 #x2d2)

(cl:defconstant BTN_TRIGGER_HAPPY20 #x2d3)

(cl:defconstant BTN_TRIGGER_HAPPY21 #x2d4)

(cl:defconstant BTN_TRIGGER_HAPPY22 #x2d5)

(cl:defconstant BTN_TRIGGER_HAPPY23 #x2d6)

(cl:defconstant BTN_TRIGGER_HAPPY24 #x2d7)

(cl:defconstant BTN_TRIGGER_HAPPY25 #x2d8)

(cl:defconstant BTN_TRIGGER_HAPPY26 #x2d9)

(cl:defconstant BTN_TRIGGER_HAPPY27 #x2da)

(cl:defconstant BTN_TRIGGER_HAPPY28 #x2db)

(cl:defconstant BTN_TRIGGER_HAPPY29 #x2dc)

(cl:defconstant BTN_TRIGGER_HAPPY30 #x2dd)

(cl:defconstant BTN_TRIGGER_HAPPY31 #x2de)

(cl:defconstant BTN_TRIGGER_HAPPY32 #x2df)

(cl:defconstant BTN_TRIGGER_HAPPY33 #x2e0)

(cl:defconstant BTN_TRIGGER_HAPPY34 #x2e1)

(cl:defconstant BTN_TRIGGER_HAPPY35 #x2e2)

(cl:defconstant BTN_TRIGGER_HAPPY36 #x2e3)

(cl:defconstant BTN_TRIGGER_HAPPY37 #x2e4)

(cl:defconstant BTN_TRIGGER_HAPPY38 #x2e5)

(cl:defconstant BTN_TRIGGER_HAPPY39 #x2e6)

(cl:defconstant BTN_TRIGGER_HAPPY40 #x2e7)
...
(cl:defconstant ABS_MT_SLOT #x2f)
...
(cl:defconstant ABS_MT_PRESSURE #x3a)

(cl:defconstant ABS_MT_DISTANCE #x3b)

(cl:defconstant ABS_MT_TOOL_X #x3c)

(cl:defconstant ABS_MT_TOOL_Y #x3d)
...
(cl:defconstant SW_CAMERA_LENS_COVER #x09)

(cl:defconstant SW_KEYPAD_SLIDE #x0a)

(cl:defconstant SW_FRONT_PROXIMITY #x0b)

(cl:defconstant SW_ROTATE_LOCK #x0c)

(cl:defconstant SW_LINEIN_INSERT #x0d)

(cl:defconstant SW_MUTE_DEVICE #x0e)
...
(cl:defconstant MSC_TIMESTAMP #x05)
...
(cl:defconstant REP_CNT (cl:+ #x01 1))
...
(cl:defconstant UINPUT_VERSION 4)

(cffi:defcstruct uinput_ff_upload
	(request_id :unsigned-int)
	(retval :int)
	(effect ff_effect)
	(old ff_effect))
...
(cffi:defcstruct uinput_ff_erase
	(request_id :unsigned-int)
	(retval :int)
	(effect_id :unsigned-int))

(cl:defconstant UINPUT_IOCTL_BASE #\U)
...
(cffi:defcstruct uinput_user_dev
	(name :pointer :count 80)
	(id input_id)
	(ff_effects_max :unsigned-int)
	(absmax :pointer :count (0x3f+1))
	(absmin :pointer :count (0x3f+1))
	(absfuzz :pointer :count (0x3f+1))
	(absflat :pointer :count (0x3f+1)))
